...
teacherRouter.get('/show-all', checkrole(["Админ", "Секретарь"]), teacherController.showAll);
...
teacherRouter.delete('/delete/:teacherId', checkrole(["Админ", "Секретарь"]), teacherController.delete);
